...
import AddDenylistCollections from '../AddDenylistCollections.vue';

const vuetify = new Vuetify();
const localVue = createLocalVue();
localVue.use(VueCompositionApi);

describe('AddDenylistCollections test', () => {
  const mockServer = {
    ...
    addItemsToPublicDenylist: jest.fn().mockResolvedValue(null),
  };
  ...
  const createWrapper = ({ server } = {}) => {
    ...
    return mount(AddDenylistCollections, renderOptions);
  };
