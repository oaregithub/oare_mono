...
import AddDenylistTexts from '../AddDenylistTexts.vue';

const vuetify = new Vuetify();
const localVue = createLocalVue();
localVue.use(VueCompositionApi);

describe('AddDenylistTexts test', () => {
  const mockServer = {
  ...
  const createWrapper = ({ server } = {}) => {
    ...
    return mount(AddDenylistTexts, renderOptions);
  };
  ...
  it('successfully adds texts to denylist', async () => {
    const wrapper = createWrapper();
    await flushPromises();
