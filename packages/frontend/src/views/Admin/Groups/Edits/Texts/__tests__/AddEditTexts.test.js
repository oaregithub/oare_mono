...
import AddEditTexts from '../AddEditTexts.vue';

const vuetify = new Vuetify();
const localVue = createLocalVue();
localVue.use(VueCompositionApi);

describe('AddEditsTexts test', () => {
  const mockServer = {
  ...
  const createWrapper = ({ server } = {}) => {
    ...
    return mount(AddEditTexts, renderOptions);
  };
  ...
  it('successfully adds texts to edit permissions', async () => {
    const wrapper = createWrapper();
    await flushPromises();
