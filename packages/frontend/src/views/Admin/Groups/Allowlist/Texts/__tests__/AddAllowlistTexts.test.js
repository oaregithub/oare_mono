...
import AddAllowlistTexts from '../AddAllowlistTexts.vue';

const vuetify = new Vuetify();
const localVue = createLocalVue();
localVue.use(VueCompositionApi);

describe('AddAllowlistTexts test', () => {
  const mockServer = {
  ...
  const createWrapper = ({ server } = {}) => {
    ...
    return mount(AddAllowlistTexts, renderOptions);
  };
  ...
  it('successfully adds texts to group allowlist', async () => {
    const wrapper = createWrapper();
    await flushPromises();
