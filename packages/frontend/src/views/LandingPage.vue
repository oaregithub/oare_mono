<template>
  <OareContentView>
    <v-row justify="center" class="title font-weight-regular">
      <v-col cols="12" lg="10">
        <p>
          Welcome to a pre-release of OARE (pronounced /’ôrə/) at
        ...
        <p>
          ...
          eventually facilitate collaborative research projects on the
        ...
        <p>
          ...
          preparation for release as well. Asset and transaction index, and
          other indexes are planned.
        </p>
        <p>
          ...
          of TC 2, 1). Plans to make the searching more forgiving are in the
          works.
        </p>
