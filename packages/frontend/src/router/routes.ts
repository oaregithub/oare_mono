 ...
 * This is where all the routes for the app are defined and connected to their respective components.
 * This is also where the navigation guards are defined for each route that requires them.
 */
